<template>
    ...
    <div class="process">
        ...
        <form action="" id="table">
            ...
            <br><br>
            <br><br>
            <p style="display: inline;font-size: 18px;margin-left: -80%;">无需审核</p>
            ...
            <br><br>
            <br><br>
            <input type="button" value="立即提交" id="sub" @click="postHandle()" style="text-align:center;">
        </form>
    </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        postHandle(){
            ...
            service.defaults.headers.common['token'] = "eyJhbGciOiJIUzUxMiJ9.eyJ1aWQiOjMsInN1YiI6InRlYWNoZXIxIiwiZXhwIjoxNjM3NDk0MDcyLCJpYXQiOjE2MzcyMzQ4NzJ9.wn21CWmGdPpZFr33KVS0YgahY0fE72zyRTepgOofcPaRFoddm9Vqti8ZrXj-RM0yU9c5rlrlf9RcUpjKatJpJQ"
            service.post('https://www.jessieback.top/classes/createClass',param)
            .then(res => {
                console.log(res);
                confirm("创建成功"+"\n"+"班级码为："+res.data.data+"\n"+"可在我的班级-班级详细中查看");
            })
