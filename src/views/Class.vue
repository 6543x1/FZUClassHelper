<template>
    ...
    <div class="nav">
        <ul class="select">
            ...
            <li @click="C_main,getHandle()"><a href="javascript:;"><img src="../assets/img/班级.png" alt="">{{class_}}</a></li>
            <li><a href="javascript:;"><img src="../assets/img/wo-de-.png" alt="">{{my}}</a></li>
        </ul>
    </div>
    <div class="line"></div>
    <div class="title">
...
export default {
  ...
  methods: {
      ...
      check(){
          this.$router.push('/Notice/' + this.classID+ "/" + this.deadLine + "/" + this.publisher + "/" + this.title)
      },
      manage(){
      ...
      C_main() {
        ...
        getHandle1(){
            ...
            let token = this.$store.state.token
            service.defaults.headers.common['token'] = token
            service.get('api'+'/classes/getMyCreatedClass',{
            })
            .then(res=>{
                console.log(res);
                this.display = res.data.data;
